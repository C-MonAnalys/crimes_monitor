...
export class EventsService {
    ...
    private async fetchJson(fileName: string): Promise<any> {
        try {
            ...
            // Silencia erro para não poluir console se o arquivo não existir remotamente
            return null;
        }
    }
